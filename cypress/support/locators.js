//por padrão, os locators são postos em um objeto para ser exportado para uso.
const locators = {
    ...
    CONTAS: { 
        NOME: '[data-test=nome]',
        BTN_SALVAR: '.btn',
        FN_XP_BTN_ALTERAR: nome => `//table//td[contains(., '${nome}')]/..//i[@class='far fa-edit']` //aqui é um xpath
    },
